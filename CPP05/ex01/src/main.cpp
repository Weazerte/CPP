...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/05 18:01:26 by eaubry            #+#    #+#             */
/*   Updated: 2024/04/05 18:04:20 by eaubry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	std::cout << "-------------------------------------------------------" << std::endl;
	{
        ...
        catch (Form::GradeTooLowException &e) // Adjusted to catch the correct exception type
        {
            std::cerr << "\033[31mConstructing default failed: " << e.what() << "\033[0m" << std::endl;
        }
